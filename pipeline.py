...
model2 = load_model("static/models/d1_ft_model.h5")
model3_loc = load_model('static/models/d2_ft_model.h5')
model3_sev = load_model('static/models/d3_ft_model.h5')
with open('static/vgg16_cat_list.pk', 'rb') as f:
    cat_list = pk.load(f)
